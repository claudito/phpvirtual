...
"iDisplayLength": 25,
 "bProcessing": true,
"sAjaxSource": "../source/empleado.php?op=1",
"aoColumns":[
...
$.getJSON('../source/empleado.php?op=6',{'id':id},function (data){
...
$.getJSON('../source/empleado.php?op=5',{'id':id},function(data){
